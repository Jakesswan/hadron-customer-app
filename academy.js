...
(function () {
  ...
  const COURSES = [
    ...
    {
      id: 'c-sew-204', trackId: 'track-sewage', code: 'SEW-204',
      title: 'Fixed-Film & Natural Treatment Systems',
      level: 'Intermediate', duration: '4 hrs',
      summary: 'Activated sludge is not the only way to treat sewage, and on a small or remote works it is rarely the best. This course covers the alternatives: the trickling filter, which despite its name filters nothing; the rotating biological contactor, which carries the microbes through the water rather than the water over the microbes; aerated lagoons, which are activated sludge without the recycle; and stabilization ponds, where sunlight and depth do the work. It closes on the sludge these processes create — and the disintegration techniques that reduce it — with the sobering figure that excess sludge treatment can consume 40 to 60% of a works’ total cost.',
      outcomes: [
        'Explain why a trickling filter is not a filter, and select rock or synthetic media for a given duty',
        'Describe how a rotating biological contactor works and calculate the media area for secondary treatment or nitrification',
        'Specify solids retention time, pH, oxygen and temperature conditions for an aerated lagoon',
        'Classify stabilization ponds by depth, oxygenation method and application',
        'Compare fixed-film, lagoon and pond options against land, energy and reliability constraints',
        'Explain the sludge reduction process and the role of sludge disintegration'
      ],
      prereqs: ['c-sew-203'],
      linkedTools: ['effluent','converters','lims'],
      sources: [
        'The Nalco Water Handbook, 3rd ed. (Ed. Flynn, McGraw-Hill) — Ch.23, Secondary Effluent Treatment: trickling filters, RBCs, aerated lagoons, stabilization ponds, sludge reduction (Table 23.10)'
      ],
      modules: [
        { id:'m1', title:'The trickling filter', duration:'45 min',
          summary:'What a trickling filter is and is not, its components, media choice, and recirculation.',
          sections:['Not a filter at all','Components and the rotary distributor','Media, depth and recirculation'] },
        { id:'m2', title:'Rotating biological contactors', duration:'40 min',
          summary:'How the bio-disc works, why staging enables nitrification, and the loading rates that size it.',
          sections:['How an RBC works','Staging and nitrification','Loading rates and design'] },
        { id:'m3', title:'Aerated lagoons', duration:'45 min',
          summary:'Activated sludge without recycle: solids retention time, BOD removal, pH, oxygen and the temperature problem.',
          sections:['Activated sludge without the recycle','Solids retention time and BOD removal','pH, oxygen and temperature'] },
        { id:'m4', title:'Stabilization ponds', duration:'40 min',
          summary:'How ponds are classified, the aerobic, facultative and anaerobic types, and why they are out of favour.',
          sections:['Classifying a pond','Aerobic, facultative and anaerobic ponds','Why ponds are out of favour'] },
        { id:'m5', title:'Choosing a process & reducing the sludge', duration:'45 min',
          summary:'Comparing the options, the sludge reduction process, and a worked RBC and lagoon sizing example.',
          sections:['Comparing the options','The sludge reduction process','Worked example: RBC area and lagoon oxygen'] },
        { id:'m6', title:'Knowledge check', duration:'15 min',
          summary:'12 interactive multi-choice questions covering modules m1–m5. 70% to pass.',
          sections:['12 interactive MCQ spanning the prior modules'],
          quiz:[
            { q:'A trickling filter removes BOD by:',
              options:['Straining solids out of the effluent','Providing large surface area on which microorganisms grow in slime and feed on organic matter','Chemical precipitation','Filtering through fine sand'],
              answer:1,
              explain:'Trickling filters are not a filtering or straining process, despite the name. The rocks are 25 to 102 mm in diameter — far too large to strain solids. They provide surface area for microorganisms to cling and grow in slime as they feed on organic matter.' },
            { q:'A secondary clarifier follows a trickling filter because:',
              options:['The filter cannot remove BOD','Excess microbial growths wash off the media and would otherwise raise effluent suspended solids','Chemicals must be added','The filter produces foam'],
              answer:1,
              explain:'Excess growths of microorganisms wash from the media and would cause high suspended solids in the plant effluent if not removed, so flow from the filter passes through a secondary clarifier to let those solids settle.' },
            { q:'The under-drain system of a trickling filter serves to:',
              options:['Support the media, drain flow to the collection channel, and permit air circulation up through the media to supply oxygen','Distribute effluent evenly','Prevent flies','Store sludge'],
              answer:0,
              explain:'The under-drain does three jobs at once. Its air circulation function is easily forgotten — the microorganisms in a trickling filter are aerobic, and the air rises through the bed from below.' },
            { q:'Compared with 76 mm rock, synthetic trickling filter media offers:',
              options:['Less surface area but better drainage','Larger surface area, greatly increased void ratio, and about 30 times lower weight, allowing depths of 6,1 m or more','The same surface area at higher cost','Lower airflow'],
              answer:1,
              explain:'Synthetic media give roughly 2,5 m² per 0,028 m³ versus 1,1–1,7 m² for rock, greatly increase void ratio for airflow, and are about 30 times lighter. Rock filters are usually no more than 3 m deep; synthetic media often reach 6,1 m or more, reducing plant footprint.' },
            { q:'Recirculating trickling filter effluent:',
              options:['Increases odour and reduces efficiency','Prevents the biological slime drying out at low flows, reduces odour potential and improves efficiency','Is only done in winter','Replaces the secondary clarifier'],
              answer:1,
              explain:'Recirculation keeps the filter wet when effluent flows are too low, reduces odour potential, and improves efficiency by giving microbes another chance at organics that escaped the first pass. For stronger effluents, two filters in series — a two-stage system — is the alternative.' },
            { q:'The essential difference between an RBC and a trickling filter is that in an RBC:',
              options:['There are no microorganisms','The microbes are passed through the effluent, rather than the effluent passing over the microbes','Treatment is anaerobic','No clarifier is needed'],
              answer:1,
              explain:'Both are attached growth processes, but the RBC rotates its discs so the attached growth is carried through the effluent and then up into the air. Rotation provides fresh media surface, brings growth into contact with effluent, and aerates both.' },
            { q:'At temperatures above 15 °C, 90% nitrification can be obtained in an RBC at a loading of about:',
              options:['0,06 m³/(d·m²)','0,16 m³/(d·m²)','1,6 m³/(d·m²)','6,0 m³/(d·m²)'],
              answer:0,
              explain:'Common loading for secondary treatment of municipal effluent is 0,08 to 0,16 m³/(d·m²) of effective media area. To nitrify, the loading must be cut to about 0,06 m³/(d·m²) — roughly a third of the upper secondary rate. Placing several sets of discs in series raises the degree of treatment further.' },
            { q:'An aerated lagoon differs from an activated sludge system in that it:',
              options:['Has no aeration','Is operated as a flow-through system without sludge recycle, usually followed by large settling ponds','Uses attached growth','Operates anaerobically'],
              answer:1,
              explain:'All solids are maintained in suspension, but aerated lagoons run as flow-through activated sludge systems without recycle. Add a clarifier with sludge recycle and they become very similar to activated sludge in operation and control.' },
            { q:'For an aerated lagoon, the amount of oxygen required varies from:',
              options:['0,1 to 0,3 times the BOD₅ removed','0,7 to 1,4 times the BOD₅ removed','2 to 4 times the BOD₅ removed','10 times the BOD₅ removed'],
              answer:1,
              explain:'Based on results from industrial and domestic installations, the oxygen requirement is 0,7 to 1,4 times the amount of BOD₅ removed. Aerated lagoons operate most satisfactorily at pH 7,2 to 7,8, achieved by holding influent pH between 6,5 and 8,3.' },
            { q:'In an aerated lagoon, halving the surface area to reduce icing:',
              options:['Has no effect on biology','Increases effluent temperature, corresponding roughly to a 50% increase in the rate of biological activity','Halves the biological activity','Prevents all treatment'],
              answer:1,
              explain:'The two most important temperature effects are reduced biological activity and treatment efficiency, and formation of ice. Icing is minimised by increasing lagoon depth or altering operation; reducing area by one-half increases effluent temperature and corresponds to roughly a 50% increase in biological activity rate.' },
            { q:'A facultative stabilization pond is characterised by:',
              options:['Aerobic conditions throughout the full liquid depth','Aerobic stabilization in the upper layers from photosynthesis and surface reaeration, facultative lower layers, and anaerobic digestion of the bottom solids','Complete anaerobic conditions','Mechanical aeration only'],
              answer:1,
              explain:'The facultative (aerobic–anaerobic) pond is the most common type. It is deeper than a high-rate pond; photosynthesis and surface reaeration oxygenate the upper layers, the lower layers are facultative, and the bottom layer of solids undergoes anaerobic digestion.' },
            { q:'The expense of treating excess sludge has been estimated at what share of the total cost of effluent treatment?',
              options:['5 to 10%','15 to 20%','40 to 60%','Over 90%'],
              answer:2,
              explain:'Biological treatment always generates considerable excess sludge — generally 0,5 to 0,6 kg dry sludge per kg BOD treated — and its treatment is estimated at 40 to 60% of the total expense of effluent treatment. That figure is why sludge disintegration processes exist.' }
          ] }
      ]
    },
    ...
    {
      id: 'c-sew-302', trackId: 'track-sewage', code: 'SEW-302',
      title: 'Nutrient Removal: Nitrification, Denitrification & Biological Phosphorus',
      level: 'Advanced', duration: '5 hrs',
      summary: 'Removing BOD is the easy part. Nitrogen and phosphorus are what actually kill a receiving water, and removing them means running the same tank under three different oxygen regimes and asking three different populations of organism to cooperate. This Advanced course teaches nitrogen removal end to end — the autotrophs that oxidise ammonia, why they wash out below five days sludge age, why they stall in cold weather, and the carbon and alkalinity arithmetic of denitrification. It then covers biological phosphorus removal, where organisms cycled between anaerobic and aerobic conditions take up more phosphorus than they need, and closes with chemical phosphorus removal and the alkalinity and sludge penalties it carries.',
      outcomes: [
        'Explain why phosphorus and ammonia nitrogen are prioritised in receiving-water protection',
        'Write the nitrification and denitrification pathways and identify the organisms responsible',
        'Diagnose nitrification failure from sludge age, temperature and inhibitory constituents',
        'Calculate the BOD to TKN ratio required for complete denitrification and specify a supplemental carbon source',
        'Explain biological phosphorus removal through cyclic DO conditions, PAO and luxury uptake',
        'Select between biological and chemical phosphorus removal, accounting for the alkalinity and sludge penalties'
      ],
      prereqs: ['c-sew-203'],
      linkedTools: ['effluent','lims','dosage'],
      sources: [
        'The Nalco Water Handbook, 3rd ed. (Ed. Flynn, McGraw-Hill) — Ch.23, Secondary Effluent Treatment: Nutrient Removal in Activated Sludge (Eqs. 23.14–23.17)'
      ],
      modules: [
        { id:'m1', title:'Why nutrients matter', duration:'40 min',
          summary:'Phosphorus and eutrophication, why ammonia outranks nitrate, and what the biomass removes without help.',
          sections:['Phosphorus, nitrogen and eutrophication','Why ammonia outranks nitrate','What the biomass removes anyway'] },
        { id:'m2', title:'Nitrification', duration:'50 min',
          summary:'The nitrogen pathway, the autotrophs and their reactions, and the two conditions that make nitrification fail.',
          sections:['The nitrogen pathway','The autotrophs and their reactions','Why nitrification fails: sludge age and temperature'] },
        { id:'m3', title:'Denitrification', duration:'50 min',
          summary:'Anoxic respiration on combined oxygen, the carbon requirement, and the alkalinity that denitrification returns.',
          sections:['Anoxic respiration','The carbon requirement','Alkalinity: what nitrification takes and denitrification returns'] },
        { id:'m4', title:'Biological phosphorus removal', duration:'50 min',
          summary:'The cyclic DO strategy, the polyphosphate accumulating organisms, PHB and luxury uptake.',
          sections:['The cyclic DO strategy','PAO, PHB and luxury uptake','What biological phosphorus removal demands of the plant'] },
        { id:'m5', title:'Chemical phosphorus removal & worked example', duration:'50 min',
          summary:'Metal salt precipitation, its alkalinity and sludge penalties, and a worked carbon and alkalinity check.',
          sections:['Metal salt precipitation','The alkalinity and sludge penalties','Worked example: carbon and alkalinity check'] },
        { id:'m6', title:'Knowledge check', duration:'15 min',
          summary:'12 interactive multi-choice questions covering modules m1–m5. 70% to pass.',
          sections:['12 interactive MCQ spanning the prior modules'],
          quiz:[
            { q:'In rivers, lakes and oceans, which nutrient is the most stringent limit on algal growth?',
              options:['Nitrogen','Phosphorus','Carbon','Potassium'],
              answer:1,
              explain:'Phosphorus is the most stringent nutrient for algal growth, so controlling phosphorus is the single most effective means to maintain clean water and prevent eutrophication. Nitrogen is next, though some algae can fix gaseous nitrogen from the air.' },
            { q:'Why is controlling ammonia nitrogen given higher priority than controlling nitrate nitrogen?',
              options:['Ammonia is the most readily utilised form for organisms that contaminate water, and it consumes dissolved oxygen when biologically oxidised','Nitrate is harmless','Ammonia is easier to measure','Nitrate cannot be removed'],
              answer:0,
              explain:'Ammonia nitrogen is the most readily utilised nitrogen form for most organisms contaminating water, and when biologically oxidised it consumes dissolved oxygen and may suffocate fish and higher life forms. Nitrate is comparatively less harmful.' },
            { q:'Microorganisms treating effluent contain approximately:',
              options:['8,7% phosphorus and 1,7% nitrogen','1,7% phosphorus and 8,7% nitrogen','50% phosphorus and 50% nitrogen','No phosphorus or nitrogen'],
              answer:1,
              explain:'The biomass contains about 1,7% phosphorus and 8,7% nitrogen, so some nitrogen and phosphorus is converted to cells and removed through sludge wastage — before any dedicated nutrient removal step is applied.' },
            { q:'Nitrification is carried out by:',
              options:['Heterotrophs under anoxic conditions','Autotrophs under aerobic conditions, consuming dissolved oxygen','Protozoa','Polyphosphate accumulating organisms'],
              answer:1,
              explain:'Nitrification occurs by autotrophs in aerobic conditions with consumption of DO. Nitrosomonas oxidises ammonium to nitrite, and Nitrobacter oxidises nitrite to nitrate. Any biological process with oxygen-rich stages and long sludge age can achieve it.' },
            { q:'Below a solids retention time of five days, nitrification fails because:',
              options:['Autotrophs rarely build up to a sufficient level due to washout','The pH is too high','There is too much oxygen','Heterotrophs die'],
              answer:0,
              explain:'The autotrophs grow slowly, so below five days SRT they are washed out of the system faster than they reproduce and never reach a sufficient population. Sludge age, not aeration, is the governing variable.' },
            { q:'Nitrification can be severely affected below which temperature?',
              options:['25 °C','20 °C','10 °C','0 °C'],
              answer:2,
              explain:'Autotrophs are more sensitive to temperature than heterotrophs, and nitrification can be severely affected below 10 °C (50 °F) — except where MLSS is very high, such as in membrane bioreactor processes running around 10 g/L.' },
            { q:'Denitrification occurs when heterotrophs:',
              options:['Consume free dissolved oxygen','Respire using the combined oxygen in nitrate, under anoxic conditions, converting it to nitrogen gas','Accumulate polyphosphate','Oxidise ammonia to nitrite'],
              answer:1,
              explain:'In the absence of free oxygen, most heterotrophs can respire by consuming combined oxygen in the form of nitrate or nitrite, releasing nitrogen gas. Because they use nitrate as the oxygen source while oxidising BOD, denitrification requires a carbon supply.' },
            { q:'Theoretically, what minimum BOD to TKN ratio is required to denitrify all the nitrogen?',
              options:['1,0:1','3,4:1','7,1:1','10:1'],
              answer:1,
              explain:'A BOD/TKN ratio of at least 3,4:1 is needed to denitrify all nitrogen, because BOD is the electron donor consumed while nitrate supplies the oxygen. Below that ratio, nitrogen removal is limited in proportion to the BOD deficiency.' },
            { q:'An industrial effluent has BOD 100 mg/L and TKN 40 mg/L. To achieve complete denitrification the operator should:',
              options:['Do nothing — the ratio is adequate','Reduce the sludge age','Add a carbon source such as methanol to the denitrification basin','Increase aeration'],
              answer:2,
              explain:'BOD/TKN = 100 ÷ 40 = 2,5, which is below the 3,4:1 minimum, so the effluent is carbon deficient. A carbon source such as methanol is added to the denitrification basin. Sanity-check: adding aeration would supply free oxygen and stop denitrification entirely.' },
            { q:'In the activated sludge process, pH in the aeration basin often falls below the optimum range mainly because:',
              options:['Denitrification consumes alkalinity','Nitrates form during oxidation of TKN, consuming alkalinity','Phosphorus is removed','Oxygen dissolves as carbonic acid'],
              answer:1,
              explain:'Nitrate formation during oxidation of TKN generates acid and consumes alkalinity. Where denitrification is also performed, the net acid formation by nitrification is reduced and pH is maintained more easily — one of the strongest arguments for pairing the two.' },
            { q:'Polyphosphate accumulating organisms (PAO) gain their advantage because they:',
              options:['Can make energy without oxygen by hydrolysing polyphosphate stored in the cell','Grow faster than all other bacteria','Do not need phosphorus','Only survive in aerobic conditions'],
              answer:0,
              explain:'Most heterotrophs make energy only in an oxygen-rich environment, but PAO can generate energy anaerobically by hydrolysing accumulated intracellular polyphosphate. Cycling the sludge between anaerobic and DO-rich conditions therefore selects for them.' },
            { q:'A drawback of removing phosphorus chemically with acid salts of iron or aluminium is that:',
              options:['It removes too much phosphorus','It neutralises the alkalinity of the waste and drops pH, which can inhibit the biological process','It cannot be done in a clarifier','It produces no sludge'],
              answer:1,
              explain:'Acid metal salts neutralise alkalinity and drop pH, and the reduction in alkalinity sometimes inhibits biological treatment in the activated sludge process. Substantial insoluble iron or aluminium hydroxide also increases sludge handling and dewatering costs. Testing whether sodium aluminate can substitute is worthwhile.' }
          ] }
      ]
    },

    {
      id: 'c-sew-303', trackId: 'track-sewage', code: 'SEW-303',
      title: 'Anaerobic Systems, Digestion & Membrane Bioreactors',
      level: 'Advanced', duration: '5 hrs',
      summary: 'Take the oxygen away and biology changes completely: growth is slow, sludge yield collapses, and the end product is a fuel. This Advanced course covers anaerobic sludge digestion — standard rate versus high rate, the two-stage reactor, and what methane recovery is worth — and anaerobic treatment of the high-strength industrial effluents that would bankrupt an aerobic plant. It works through the three-stage biochemistry from acidification to methanogenesis, the Monod kinetics that show why a 15 °C temperature drop can cut treatment rate elevenfold, and closes with the membrane bioreactor, which removes the clarifier entirely and with it every constraint that settleability ever imposed on the biology.',
      outcomes: [
        'Distinguish standard-rate from high-rate anaerobic digestion and describe the two-stage configuration',
        'Explain why anaerobic treatment yields minimal sludge but requires long detention times',
        'Trace the anaerobic biochemistry from acidification through acetogenesis to methanogenesis',
        'Apply the Monod relationship and its temperature coefficients to assess anaerobic reactor performance',
        'Calculate methane production from COD removed and judge whether a reactor can heat itself',
        'Explain how a membrane bioreactor decouples the biological process from biomass settling, and manage flux and fouling'
      ],
      prereqs: ['c-sew-302'],
      linkedTools: ['effluent','converters','lims'],
      sources: [
        'The Nalco Water Handbook, 3rd ed. (Ed. Flynn, McGraw-Hill) — Ch.23, Secondary Effluent Treatment: Anaerobic Systems and Membrane Bioreactors (Eqs. 23.18–23.22, Tables 23.11–23.12)'
      ],
      modules: [
        { id:'m1', title:'Anaerobic sludge digestion', duration:'45 min',
          summary:'What digestion achieves, standard rate versus high rate, the two-stage reactor and methane use.',
          sections:['What digestion achieves','Standard rate and high rate','The two-stage system and methane'] },
        { id:'m2', title:'Anaerobic treatment of high-strength effluent', duration:'45 min',
          summary:'Where anaerobic treatment fits, the consequences of slow growth, and the effluents it suits.',
          sections:['Where anaerobic treatment fits','The consequences of slow growth','The effluents it suits'] },
        { id:'m3', title:'The anaerobic biochemistry', duration:'50 min',
          summary:'Acidification, acetogenesis and methanogenesis — and where COD actually disappears.',
          sections:['Acidification','Acetogenesis','Methanogenesis'] },
        { id:'m4', title:'Kinetics, temperature & methane yield', duration:'50 min',
          summary:'The Monod relationship, the temperature coefficients, and a worked methane and self-heating calculation.',
          sections:['The Monod relationship','Temperature coefficients','Worked example: methane yield and self-heating'] },
        { id:'m5', title:'Membrane bioreactors', duration:'45 min',
          summary:'Decoupling biology from settling, the operating envelope MBR unlocks, and managing flux and fouling.',
          sections:['Decoupling biology from settling','The operating envelope','Flux, fouling and cleaning'] },
        { id:'m6', title:'Knowledge check', duration:'15 min',
          summary:'12 interactive multi-choice questions covering modules m1–m5. 70% to pass.',
          sections:['12 interactive MCQ spanning the prior modules'],
          quiz:[
            { q:'A standard-rate anaerobic digester has a detention time of:',
              options:['15 days or less','60 to 90 days','1 to 2 days','About 6 months'],
              answer:1,
              explain:'In the standard-rate system the reactor contents are unmixed and unheated, requiring 60 to 90 days. The high-rate reactor is completely mixed and heated to 29–38 °C, giving a typical detention time of 15 days or less.' },
            { q:'In the common two-stage digestion system, the second-stage reactor:',
              options:['Is heated and mixed','Is neither mixed nor heated, and is allowed to stratify to remove digested sludge, supernatant liquor and methane gas','Is aerated','Adds coagulant'],
              answer:1,
              explain:'The first stage is heated and mixed; the second stage is left to stratify so that concentrated digested sludge, supernatant liquor and methane gas separate. A scum layer generally develops on the liquor surface in domestic systems.' },
            { q:'Anaerobic digestion reduces total solids by approximately:',
              options:['5 to 10% by weight','20 to 25% by weight','45 to 50% by weight','Over 90% by weight'],
              answer:2,
              explain:'The resulting sludge is well stabilised, with total solids reduced 45 to 50% by weight. The methane produced is used to heat the digester, heat buildings, generate electricity, or drive mechanical equipment such as pumps and blowers.' },
            { q:'Compared with the activated sludge process, anaerobic treatment has:',
              options:['A faster rate of treatment and higher sludge yield','A slower rate of treatment and considerably lower sludge yield','The same rate and yield','No sludge at all'],
              answer:1,
              explain:'Conversion of organics to methane yields little energy, so cell growth is slow and organic growth is low. Both the rate of treatment and the sludge solids yield are considerably less than in activated sludge — meaning long detention times, but minimal sludge for disposal.' },
            { q:'Anaerobic treatment is chiefly used for effluents that are:',
              options:['Very dilute','High in organic content, such as from meatpacking, breweries, alcohol production and pulp and paper','High in heavy metals','Cold'],
              answer:1,
              explain:'It suits high-organic effluents from meatpacking, breweries, alcohol production, pharmaceutical and food processing, pulp and paper, and oilfield produced water. Alcohol stillage can reach 40 g/L BOD and 120 g/L COD. Typical organic removals are 75 to 95%.' },
            { q:'During the acidification stage of anaerobic degradation:',
              options:['Most of the COD is destroyed','There is minimal reduction of COD; any reduction via hydrogen formation seldom exceeds 10%','Methane is the main product','Nitrogen gas is released'],
              answer:1,
              explain:'Acidification produces acetic, propionic and butyric acids with minimal COD reduction. Should a large amount of hydrogen occur, some COD reduction results, but this seldom exceeds 10%. The COD is rearranged, not removed.' },
            { q:'Acetogenic microorganisms convert:',
              options:['Acetic acid to methane','All acids higher than acetic acid to acetic acid and hydrogen','Methane to carbon dioxide','Ammonia to nitrate'],
              answer:1,
              explain:'Acetogens convert higher acids — for example propionic acid, per Eq. 23.18 — to acetic acid, carbon dioxide and hydrogen. In this reaction COD reduction does occur, in the form of hydrogen. Methanogens then convert the acetic acid and hydrogen to methane.' },
            { q:'How much methane is produced per 0,45 kg of COD or ultimate BOD removed, at standard conditions?',
              options:['0,016 m³','0,16 m³','1,6 m³','16 m³'],
              answer:1,
              explain:'0,45 kg of COD or BOD_L removed yields 0,16 m³ of methane at 0 °C and one atmosphere — roughly 0,36 m³ of methane per kg of COD removed. Low BOD and COD effluents may not produce enough gas to heat the reactor; high-strength wastes produce excess gas usable as heat or electricity.' },
            { q:'In the Monod relationship for anaerobic degradation, dropping the temperature from 35 °C to 20 °C changes the half-saturation constant Ks from about 164 mg/L to about:',
              options:['16 mg/L','164 mg/L','930 mg/L','2130 mg/L'],
              answer:3,
              explain:'Ks rises from 164 mg/L at 35 °C to 930 at 25 °C and 2130 at 20 °C, while Kmax falls from 6,67 to 3,85 per day. Because Ks appears in the denominator, the effect on rate at low substrate concentration is far more severe than the fall in Kmax alone would suggest.' },
            { q:'A membrane bioreactor replaces the secondary clarifier with ultrafiltration or microfiltration membranes of pore size:',
              options:['0,04 to 0,4 µm','4 to 40 µm','0,4 to 4 mm','Under 0,001 µm'],
              answer:0,
              explain:'These microporous membranes have a pore size range between 0,04 and 0,4 µm, allowing almost complete particle separation from the mixed liquor and giving lower effluent TSS than a conventional settling basin.' },
            { q:'The most important consequence of the MBR is that it:',
              options:['Removes the need for aeration','Decouples the biological process from the settling of biomass, permitting MLSS of 8 to 15 g/L, long SRT and low HRT','Eliminates sludge entirely','Removes dissolved salts'],
              answer:1,
              explain:'By separating solids with a membrane rather than gravity, the MBR allows operation at conditions that would be untenable in a conventional system — high MLSS, long SRT and low hydraulic retention time — which in a conventional plant would cause sludge bulking and poor settleability.' },
            { q:'To maintain flux across an MBR membrane, the main operating variables are:',
              options:['Aeration rate and suction pressure, supported by intermittent operation and periodic chemical cleaning','Temperature and pH only','Sludge age alone','Coagulant dose'],
              answer:0,
              explain:'Aeration rate and suction pressure control flux in a submerged MBR; cross-flow velocity does so in an external MBR. Both rely on intermittent operation, during which the surface is scoured by water and air, and hollow fibre systems add a periodic back pulse of permeate. Membranes are cleaned chemically with sodium hypochlorite, caustic or organic acids.' }
          ] }
      ]
    },
    ...
    {
      id: 'c-eff-302', trackId: 'track-effluent', code: 'EFF-302',
      title: 'Tertiary Treatment, Heavy Metal Removal & Sludge Handling',
      level: 'Advanced', duration: '5 hrs',
      summary: 'What leaves after secondary treatment still carries phosphate, refractory organics, pathogens and — on an industrial site — dissolved metals. This Advanced course covers effluent disinfection and why no mechanical method leaves a residual; tertiary phosphate precipitation with aluminium, iron and lime, and the pH window each demands; activated carbon for organics and chlorine residual. It then treats heavy metals through the solubility product that governs every precipitation decision, the special cases of hexavalent chromium and cyanide, and the prevention-first management programme that beats end-of-pipe treatment. It closes on the sludge you have created: thickening, dewatering and the economics of removing water.',
      outcomes: [
        'Specify a tertiary disinfection method and explain why mechanical methods require chemical follow-up',
        'Select aluminium, iron or lime for phosphate precipitation and state the pH window and sludge penalty of each',
        'Explain the role of activated carbon in organics and chlorine residual removal',
        'Use the solubility product to select hydroxide, sulfide or carbonate precipitation for a given metal',
        'Describe the two-stage alkaline chlorination of cyanide and the pretreatment of hexavalent chromium',
        'Calculate the volume reduction achieved by sludge thickening and select a dewatering target from the disposal route'
      ],
      prereqs: ['c-eff-201'],
      linkedTools: ['effluent','dosage','lims'],
      sources: [
        'The Nalco Water Handbook, 3rd ed. (Ed. Flynn, McGraw-Hill) — Ch.24, Tertiary Effluent Treatment (Eqs. 24.4–24.6)',
        'The Nalco Water Handbook, 3rd ed. (Ed. Flynn, McGraw-Hill) — Ch.25, Heavy Metal Removal (Eqs. 25.17–25.18, Table 25.2)',
        'The Nalco Water Handbook, 3rd ed. (Ed. Flynn, McGraw-Hill) — Ch.26, Sludge Manipulation'
      ],
      modules: [
        { id:'m1', title:'Tertiary objectives & disinfection', duration:'40 min',
          summary:'What tertiary treatment adds, why mechanical disinfection leaves no residual, and the chemical options.',
          sections:['What tertiary treatment adds','Mechanical disinfection and the residual problem','Chlorination and its alternatives'] },
        { id:'m2', title:'Phosphate & organics removal', duration:'50 min',
          summary:'Why phosphate persists, aluminium, iron and calcium precipitation with their pH windows, and activated carbon.',
          sections:['Why phosphate persists','Aluminium, iron and calcium precipitation','Activated carbon for organics'] },
        { id:'m3', title:'Heavy metals: the chemistry', duration:'50 min',
          summary:'The solubility product, hydroxide, sulfide and carbonate precipitation, and the two problem species.',
          sections:['The solubility product','Hydroxide, sulfide and carbonate precipitation','Hexavalent chromium and cyanide'] },
        { id:'m4', title:'Heavy metals: the programme', duration:'40 min',
          summary:'The mechanical, operational and chemical approach, the operational factors, and closed loop recycling.',
          sections:['Prevention before end-of-pipe','Operational factors','Closed loop recycling'] },
        { id:'m5', title:'Sludge thickening & dewatering', duration:'50 min',
          summary:'Why thickening pays, the thickening and dewatering methods, and a worked volume-reduction example.',
          sections:['Why thickening pays','Thickening and dewatering methods','Worked example: thickening and the chemical choice'] },
        { id:'m6', title:'Knowledge check', duration:'15 min',
          summary:'12 interactive multi-choice questions covering modules m1–m5. 70% to pass.',
          sections:['12 interactive MCQ spanning the prior modules'],
          quiz:[
            { q:'Ultraviolet light, radiation and heat can all kill bacteria in effluent, but:',
              options:['None of them leave a residual effect, so bacteria can recontaminate the water afterwards','They are more expensive than any chemical','They only work at high pH','They produce trihalomethanes'],
              answer:0,
              explain:'Mechanical or physical disinfection kills but leaves no persistence, so treated water can be recontaminated. Mechanical treatment is therefore often followed by a chemical treatment that has disinfection persistence in water.' },
            { q:'Ozone and chlorine dioxide are less commonly used for effluent disinfection because:',
              options:['They are ineffective against bacteria','As gases they tend to flash off and do not provide long-term microbial control','They are illegal','They cannot be generated on site'],
              answer:1,
              explain:'Both are effective oxidants but, being gases, they flash off and give no lasting residual. Chlorination remains the most common practice because of extensive knowledge of how it works, industry-wide acceptance and overall lower cost.' },
            { q:'A phosphate residual of about 0,5 mg/L in the aeration basin effluent is:',
              options:['A discharge violation','Required to ensure biomass health','The maximum allowed anywhere','Only relevant to drinking water'],
              answer:1,
              explain:'Phosphate is required in secondary treatment to maintain healthy biomass for efficient BOD reduction, and around 0,5 mg/L residual ensures it. That level suits most surface water discharge requirements, though regulations trend lower — hence tertiary phosphate removal.' },
            { q:'Polyphosphates and organic phosphates cannot be precipitated directly with metal ions because:',
              options:['They are gases','They do not readily react with metallic ions until converted to orthophosphate','They are already insoluble','They react too violently'],
              answer:1,
              explain:'Only orthophosphate readily reacts with aluminium, iron or calcium ions. Polyphosphates and organic phosphates must first be converted to orthophosphate by biological treatment and hydrolysis; small amounts may be removed by absorption on the floc solids formed.' },
            { q:'The optimum pH for phosphate precipitation with alum is:',
              options:['About 6,0, within a range of 5,5 to 6,5','About 8,5','About 10,0','Any pH'],
              answer:0,
              explain:'Optimum pH for metal phosphate precipitation with alum ranges from 5,5 to 6,5, with 6,0 being best. Adjust the water so the FINAL pH after chemical addition lands near 6,0 — this reduces aluminium hydroxide formation and maximises aluminium phosphate precipitation.' },
            { q:'Iron treatment for phosphate is most effective in the pH range:',
              options:['4 to 5','5,5 to 6,5','7 to 8','9 to 10'],
              answer:2,
              explain:'Ferric treatment is effective at pH 7 to 8. As with alum, adjust so that the desired final pH is obtained once the chemical is added, maximising ferric phosphate precipitation and minimising ferric hydroxide formation.' },
            { q:'Compared with sodium aluminate, the total lime sludge generated for phosphate removal is:',
              options:['About the same','More than 2,25 times as much','Half as much','Ten times as much'],
              answer:1,
              explain:'The total lime sludge generated is more than 2,25 times the amount produced when sodium aluminate is used for phosphate removal — a decisive figure once sludge thickening, dewatering and hauling costs are counted.' },
            { q:'In selecting a precipitation agent for a dissolved metal, the general rule is:',
              options:['The larger the solubility product, the more effectively the metal is removed','The smaller the solubility product, the less soluble the compound and the more effectively the metal is removed','Solubility product is irrelevant','Only pH matters'],
              answer:1,
              explain:'The solubility product Ksp measures the tendency of a metal to precipitate when the appropriate anion is added. The smaller the Ksp, the less soluble the compound. Ferric hydroxide has a Ksp of about 1,1 × 10⁻³⁶ and is very effectively removed by caustic addition.' },
            { q:'Comparing solubility products, metal sulfides such as HgS, CuS and ZnS are generally:',
              options:['More soluble than the corresponding hydroxides and carbonates','Less soluble, making sulfide a very effective precipitation agent','Equally soluble','Not precipitates at all'],
              answer:1,
              explain:'Sulfides typically have far lower solubility products than the corresponding hydroxides or carbonates — mercury(II) sulfide sits around 10⁻⁵⁰. Their low Ksp makes hydroxide, sulfide and carbonate all effective precipitation agents, with sulfide the most aggressive.' },
            { q:'In the two-stage alkaline chlorination of cyanide, the first stage:',
              options:['Adjusts pH to about 11 and oxidises cyanide to cyanate','Lowers pH to 8,5 and produces nitrogen gas','Adds sulfuric acid only','Precipitates the metal'],
              answer:0,
              explain:'Stage one raises pH to approximately 11 and adds chlorine gas or sodium hypochlorite to oxidise cyanide to cyanate. Stage two lowers pH to 8 to 9 and adds more oxidant, oxidising cyanate to carbon dioxide and nitrogen. Caustic is controlled on pH, and oxidant on an ORP probe.' },
            { q:'Cyanide-bearing effluent should be pretreated before mixing with other waste streams because:',
              options:['It smells','Cyanide forms soluble complexes with metals that hinder subsequent removal by precipitation','It is too dilute','It raises the temperature'],
              answer:1,
              explain:'Beyond its toxicity, cyanide forms soluble metal complexes that defeat downstream precipitation agents. Waste segregation — keeping hazardous and non-hazardous streams apart — is a core operational factor, because mixing wastes complicates removal of the hazardous components.' },
            { q:'Increasing sludge solids concentration from 1% to 10% dry solids by weight reduces sludge volume by approximately:',
              options:['10%','50%','90%','99%'],
              answer:2,
              explain:'Volume varies inversely with solids concentration: 1% to 2% halves the volume (50% reduction), and 1% to 10% reduces it by 90%. Since digestion, dewatering and transport costs are all sensitive to the amount of water handled, thickening pays for itself downstream.' }
          ] }
      ]
    },
